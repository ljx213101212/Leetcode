// HelloKeyboard.cpp : Defines the entry point for the application.
//

#include "framework.h"
#include "HelloKeyboard.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_HELLOKEYBOARD, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_HELLOKEYBOARD));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_HELLOKEYBOARD));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_HELLOKEYBOARD);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   RAWINPUTDEVICE rawInputDevice[50];
   rawInputDevice[0].usUsagePage = 1;
   rawInputDevice[0].usUsage = 6;
   rawInputDevice[0].dwFlags = RIDEV_INPUTSINK;//RIDEV_NOLEGACY //RIDEV_INPUTSINK
